...
# Office and structure words only: the fallback for a body with no anchors keeps descriptive words (UNION, PARK,
# COMMUNITY, DEVELOPMENT) so a generic-named body must match on all of them, not on one.
