...
tables, grouped by each table's real LIST-partition column (spec-driven: Voter->"State",
DistrictVoter->"state"); a flat table (District, DistrictStats) yields a total count only.
