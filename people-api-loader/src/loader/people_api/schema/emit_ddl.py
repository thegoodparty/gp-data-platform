...
- `VOTER_TARGET_COLUMNS` (loader.schema.voter_columns) — the curated
...
def emit_target_schema(
    ...
    *,
    ...
    out: list[str] = [
        "-- Auto-generated by loader.schema.emit_ddl.",
        "-- Source of truth: loader.schema.voter_columns.VOTER_TARGET_COLUMNS.",
