...
-- were never live would be noise. Before slug history began we cannot tell,
-- so those retirements are all kept.
where published.id is not null or retired.last_minted_to < slug_history.started_at
