with
    ...
    source as (select * from {{ source("er_source", "pairwise_elected_officials") }}),
    ...
    renamed as (
        ...
        select
            ...
            -- office_type comparison (EO-specific)
            office_type_l,
            office_type_r,
            cast(gamma_office_type as int) as gamma_office_type,
            cast(bf_office_type as double) as bf_office_type,

            -- office_level comparison (EO-specific)
            office_level_l,
            office_level_r,
            ...
            cast(br_candidate_id_l as int) as br_candidate_id_l,
            cast(br_candidate_id_r as int) as br_candidate_id_r,
            ts_officeholder_id_l,
