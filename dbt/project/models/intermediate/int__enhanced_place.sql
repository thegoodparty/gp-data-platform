...
with
    ...
    enhanced_place as (
        select
            ...
            tbl_fast_facts.population as population,
            tbl_fast_facts.density as density,
            tbl_fast_facts.income_household_median as income_household_median,
            tbl_fast_facts.unemployment_rate as unemployment_rate,
            tbl_fast_facts.home_value as home_value,
        ...
        left join
            {{ ref("int__place_fast_facts") }} as tbl_fast_facts
            on tbl_place.database_id = tbl_fast_facts.database_id
        left join
