# python file for calculating viability scores for BallotReady candidates using MLflow model.
# this file is used to calculate the viability scores for the BallotReady candidates and save the results to the int__ballotready_viability_scoring table.
...
def model(dbt, session: SparkSession) -> DataFrame:
    ...
    df_hs = df_candidates.select(
        ...
        col("party_affiliation").alias("properties_candidate_party"),
