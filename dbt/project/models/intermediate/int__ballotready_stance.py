...
def base64_encode_id(candidacy_id: str) -> str:
    """
...
def get_stance_ids(encoded_candidacy_id: str) -> pd.DataFrame:
    """
...
def model(dbt, session):
    ...
    candidacies['encoded_candidacy_id'] = candidacies['candidacy_id'].apply(base64_encode_id)
