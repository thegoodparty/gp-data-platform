...
renders the rows for dbt_sroberts.gm_body_rule_shadow. Catches: the divergence flag firing on the wrong
side, and an INSERT the Statement API would mis-quote."""
...
RUN = dict(
    ...
    shape="B_live",
    universe_loaded_at="2026-09-18 08:07:00",
)
