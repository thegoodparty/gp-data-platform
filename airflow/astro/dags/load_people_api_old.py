...
@dag(
    dag_id="load_people_api_old",  # legacy District/DistrictStats sync; still REQUIRED (the Voter-only
    # load_people_api loader does not cover the District family yet; see DATA-2100). Retire this DAG
    # only after DATA-2100 lands.
