...
class magic_dict(dict):
    """A dictionary that returns "MOCKED_KEY_VALUE" if the key is not found."""

    def __init__(self, *args, **kwargs):
        """Initialize the magic_dict with the given arguments and keyword arguments."""
        self.update(*args, **kwargs)

    def __getitem__(self, key):
        """Get the value for the given key, returning "MOCKED_KEY_VALUE" if the key is not found."""
